...
<body>
    ...
    <div class="container">
        <div class="head">
        <h1 class="  text-center mb-5" >Birds Animal Beauti</h1>
        </div>
        <div class="row">
            ...
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="card" style="width: 22rem;">
                        <img height="330" class="card-img-top" src= '.$topic_imges.'  alt="...">
        ...
        <div class="text-center">
            <button id="nextButton" class="btn btn-primary pe-5 ps-5 mb-5"><b>Next <span><i class="fa-solid fa-less-than fa-lg" style="color: #fbfcfe;"></i></span> 100<b></button>
        </div>
    </div>
    <?php include 'footer.php'; ?>

     <!-- JavaScript for the "Next" button functionality -->
     <script>
        document.getElementById("nextButton").addEventListener("click", function() {
            // Define the URL of the next page
            var nextPageURL = "Collection.php"; // Replace "next_page.html" with the URL of your next page
